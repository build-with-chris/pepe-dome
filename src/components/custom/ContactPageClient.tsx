 ...
 * Bekommt dict + lang per Props. Adresse/Mail/Phone-Werte kommen aus
      ...
      <div className="stage-container py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--pepe-ink)] border border-[var(--pepe-line)] rounded-xl p-6 hover:border-[var(--pepe-gold)] transition-colors duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[var(--pepe-white)] mb-2">{t.cards.phone.title}</h3>
                  <a href={`tel:${phone.replace(/\s/g, '')}`} className="text-[var(--pepe-t80)] hover:text-[var(--pepe-gold)] transition-colors">
                    {phone}
                  </a>
                </div>
              </div>
          ...
          <div className="bg-[var(--pepe-ink)] border border-[var(--pepe-line)] rounded-xl p-8">
            <h2 className="text-2xl font-bold text-[var(--pepe-white)] mb-6">{t.form.title}</h2>
            ...
            {status === 'success' ? (
              <div className="text-center py-12">
                ...
                <p className="text-[var(--pepe-t64)]">{t.form.successText}</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-[var(--pepe-t80)] mb-2">
