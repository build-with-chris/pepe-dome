      ...
      <div className="stage-container py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {/* Die Karten waren h3, das Formular daneben h2 — nach der
                Seitenüberschrift sprang die Gliederung also von h1 direkt auf
                h3. Wer sich per Screenreader durch die Überschriften hangelt,
                verliert dabei die Ebene. Diese Überschrift schließt die Lücke;
                sichtbar ist sie nicht, weil die Karten für sich sprechen. */}
            <h2 className="sr-only">{t.hero.title}</h2>
            {/* Callback */}
            <div className="bg-[var(--pepe-ink)] border border-[var(--pepe-line)] rounded-xl p-6 hover:border-[var(--pepe-gold)] transition-colors duration-300">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-lg bg-[var(--pepe-gold)]/10 flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6 text-[var(--pepe-accent-text)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-[var(--pepe-ink)] border border-[var(--pepe-line)] rounded-xl p-6 hover:border-[var(--pepe-gold)] transition-colors duration-300">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-lg bg-[var(--pepe-gold)]/10 flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6 text-[var(--pepe-accent-text)]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-[var(--pepe-accent-text)] hover:underline font-medium"
                  >
            ...
            <div className="bg-[var(--pepe-ink)] border border-[var(--pepe-line)] rounded-xl p-6 hover:border-[var(--pepe-gold)] transition-colors duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${email}`} className="text-[var(--pepe-accent-text)] hover:underline">{email}</a>
                </div>
              </div>
            </div>
                ...
                {whatsappLink && (
                  <div className="border-t border-[var(--pepe-line)] pt-8">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[var(--pepe-gold)]/10 border border-[var(--pepe-gold)] text-[var(--pepe-accent-text)] font-medium hover:bg-[var(--pepe-gold)]/20 transition-colors"
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {(['callback', 'whatsapp', 'email'] as Channel[]).map((ch) => (
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-lg border text-sm font-medium transition-colors ${
                          formData.channel === ch
                            ? 'border-[var(--pepe-gold)] bg-[var(--pepe-gold)]/10 text-[var(--pepe-accent-text)]'
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    required
                    disabled={status === 'loading'}
                    className="mt-1 w-4 h-4 rounded border-[var(--pepe-line)] bg-[var(--pepe-surface)] text-[var(--pepe-accent-text)] focus:ring-[var(--pepe-gold)] focus:ring-offset-0"
                  />
        ...
        <section className="mt-32 pt-16 border-t border-[var(--pepe-line)]">
          ...
          <div className="text-center mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[var(--pepe-accent-text)] hover:underline font-medium"
            >
