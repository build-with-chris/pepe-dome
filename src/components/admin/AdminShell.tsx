...
const navItems: NavItem[] = [
  ...
  {
    // Fehlte hier seit dem Contentplan-Feature: die Seite existiert unter
    // /admin/contentplan, war aber nur ueber die direkte Adresse erreichbar.
    label: 'Contentplan',
    href: '/admin/contentplan',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
