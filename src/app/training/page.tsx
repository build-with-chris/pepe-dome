  ...
  },
  {
    ...
    kurse: [
      ...
      },
      {
        ...
        time: '17:30 – 19:00',
        title: 'Capoeira für Erwachsene',
        sub: 'Open Level · mit Dayela',
        target: 'erwachsene',
        trainer: 'Dayela',
        day: 'Dienstag',
        description:
          'Capoeira — die brasilianische Kampfkunst, die Tanz, Akrobatik und Musik in einem Spiel vereint. Du lernst die Grundbewegungen (Ginga, Esquivas, Tritte), Akrobatik-Elemente und das Spiel im Kreis (Roda).',
        inhalte: [
          'Ginga & Grundbewegungen',
          'Esquivas (Ausweichbewegungen) & Tritte',
          'Akrobatik-Elemente: Au, Macaco, Aú-Variationen',
          'Roda — das Spiel im Kreis mit musikalischer Begleitung',
        ],
        fuerWen: 'Erwachsene, alle Levels — Einstieg jederzeit möglich',
      },
    ],
  },
  {
