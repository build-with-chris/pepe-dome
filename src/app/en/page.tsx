      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <Link href="/en/veranstaltungen" className="btn-primary btn-lg">
              Discover Events
            </Link>
            <a
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="space-y-4 mb-6">
                  {nextEvent.ticketDates ? (
                    <div className="space-y-3">
                      <h4 className="text-lg font-semibold text-white/90 mb-3">Tickets for both dates:</h4>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      {nextEvent.registrationEmail ? (
                        <a
                          href={`mailto:${nextEvent.registrationEmail}?subject=Registration: ${nextEvent.title}`}
                        ...
                        <a
                          href={nextEvent.externalTicketUrl || "/en/kontakt#kontaktformular"}
              ...
              <div className="order-1 md:order-2 relative">
                ...
                <div className={`absolute -top-6 -left-3 px-3 py-2 rounded-lg font-bold text-xs shadow-lg ${nextEvent.id === 'freeman-festival' ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white' : 'bg-gradient-to-r from-white to-gray-100 text-black border border-gray-300'}`}>
                  {nextEvent.id === 'freeman-festival' ? '🎪 FESTIVAL' : 'NEXT EVENT'}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            >
              ...
              <h3 className="display text-xl font-bold mb-3 group-hover:text-white transition-colors">Events & Shows</h3>
              <p className="muted text-sm group-hover:text-white/90 transition-colors mb-4">
                From spectacular festivals to intimate performances - experience culture in a unique atmosphere
              </p>
            ...
            >
              ...
              <h3 className="display text-xl font-bold mb-3 group-hover:text-white transition-colors">Corporate Events</h3>
              <p className="muted text-sm group-hover:text-white/90 transition-colors mb-4">
                Unforgettable team building and corporate events in an extraordinary location
              </p>
              <div className="inline-flex items-center gap-2 text-orange-400 group-hover:text-orange-300 transition-colors">
                <span className="text-sm font-semibold">Plan Your Event</span>
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </div>
            </Link>
          </div>
      ...
      <section className="py-20 px-6 text-center bg-gradient-to-b from-black/0 to-black/20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/en/kontakt#kontaktformular" className="btn-primary btn-lg">
              Get In Touch
            </Link>
            <Link
              href="/en/ueber"
      ...
      <section className="py-12 px-6 border-t border-white/10">
        <div className="w-full">
          <div className="text-center mb-8">
            <p className="text-sm text-white/60 mb-6">Supported by the City of Munich and Creative Munich</p>
