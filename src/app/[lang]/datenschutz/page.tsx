/**
 * Datenschutz Page — localized wrapper.
 *
 * Der juristische Inhalt bleibt deutsch (rechtsverbindliche Fassung).
 * Auf /en/datenschutz erscheint zusätzlich ein Hinweis-Banner, der das klarstellt.
 */
...
export default async function DatenschutzPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--pepe-black)]">
      ...
      <div className="pt-8">
        <LegalEnNotice lang={lang} message={dict.legal.enDisclaimer} />
      </div>
