...
const content: Record<Locale, Content> = {
  de: {
    meta: {
      ...
      description:
        'Unterstütze den Pepe Dome und den Trägerverein Circus Akademie München e.V. per Überweisung oder PayPal.',
    },
    hero: {
      title: 'Spenden',
      subtitle:
        'Der Pepe Dome wird vom gemeinnützigen Verein Circus Akademie München e.V. getragen. Danke für deine Unterstützung.',
    },
    intro:
      'Wenn du unsere Arbeit für zeitgenössischen Zirkus, Artistik und Kultur in München fördern möchtest, freuen wir uns über jede Spende.',
    bank: {
      ...
      purposeText: 'Spende Pepe Dome',
    },
    paypal: {
      title: 'PayPal',
      recipientLabel: 'PayPal-Adresse',
      note:
        'Bitte in PayPal „an Freunde senden" wählen und im Verwendungszweck „Spende Pepe Dome" angeben.',
      cta: 'Mit PayPal spenden',
    },
    thanks: 'Herzlichen Dank — jeder Beitrag hilft, den Dome offen zu halten.',
  },
  en: {
    meta: {
      title: 'Donate — Circus Akademie München e.V.',
      description:
        'Support the Pepe Dome and its non-profit operator Circus Akademie München e.V. via bank transfer or PayPal.',
    },
    hero: {
      title: 'Donate',
      subtitle:
        'The Pepe Dome is operated by the non-profit Circus Akademie München e.V. Thank you for your support.',
    },
    intro:
      'If you would like to support our work for contemporary circus, artistry and culture in Munich, we appreciate every donation.',
    bank: {
      title: 'Bank details',
      ...
      purposeText: 'Donation Pepe Dome',
    },
    paypal: {
      title: 'PayPal',
      recipientLabel: 'PayPal address',
      note:
        'Please use PayPal "send to friends" and add "Donation Pepe Dome" as reference.',
